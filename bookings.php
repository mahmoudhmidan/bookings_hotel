        ...
        <div class="box-container">
            ...
            if($select_bookings->rowcount() > 0){
                ...
                <div class="box">
                    ...
                    <p>check_in : <span><?= $fetch_booking['check_in']; ?></span></p>
                    <p>check_out : <span><?= $fetch_booking['check_out']; ?></span></p>
                    ...
                    <form action="" methd="post">
                        ...
                        <input type="submit" value="cancel booking" name="cancel" class="btn" onclick="return confirm('cancel this book booking ?');">
